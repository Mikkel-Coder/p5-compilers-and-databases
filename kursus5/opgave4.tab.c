...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_normal_assignment = 13,         /* normal_assignment  */
  YYSYMBOL_register_assignment = 14        /* register_assignment  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "VARNAME", "NUMBER",
  "REG", "';'", "'='", "'#'", "'+'", "$accept", "program", "statement",
  "normal_assignment", "register_assignment", YY_NULLPTR
};
...
{
       1,     7,     9,     8,    12,     2,    10,    11,    15,    13,
      17,    14,     0,     0,     0,    16
};

static const yytype_int8 yycheck[] =
{
       3,     7,     0,     5,     3,     8,     6,     4,     3,    10,
       3,     7,    -1,    -1,    -1,     9
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* normal_assignment: VARNAME '=' NUMBER  */
#line 49 "opgave4.y"
                       {
...
#line 1090 "opgave4.tab.c"
    break;

  case 7: /* register_assignment: '#' REG VARNAME '=' VARNAME '+' VARNAME  */
#line 61 "opgave4.y"
                                            {
        /* Print the ASM code including comments. */
        fprintf(yyout, "; %s = %s + %s\n", (yyvsp[-4].s), (yyvsp[-2].s), (yyvsp[0].s));
        fprintf(yyout, "MOV %s, [%s]\n", (yyvsp[-5].s), (yyvsp[-2].s));
...
#line 1111 "opgave4.tab.c"
    break;


#line 1115 "opgave4.tab.c"
